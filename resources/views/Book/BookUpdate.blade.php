            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="card card-secondary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ url('/Book/BookUpdate', $book->id) }}" method="POST" enctype="multipart/form-part">
                            @csrf
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-7">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="name" placeholder="enter book name" value="{{ $book->name }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="author" placeholder="enter book author" value="{{ $book->author }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="year" placeholder="enter book year" value="{{ $book->year }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="ISBN" placeholder="enter book ID" value="{{ $book->ISBN }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
