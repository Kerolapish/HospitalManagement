                                              ...
                                              <div class="col-md-8">
                                                  <div class="form-group">
                                                      ...
                                                      <input type="text" class="form-control" name="name"
                                                          placeholder="enter book name" value="{{ $user->name }}">
                                                  </div>
                                              </div>
                                              ...
                                              <div class="col-md-4">
                                                  <div class="form-group">
                                                      ...
                                                      <input type="text" class="form-control" name="author"
                                                          placeholder="enter book author" value="{{ $user->IcNum }}">
                                                  </div>
                                              </div>
                                              ...
                                              <div class="col-md-4">
                                                  <div class="form-group">
                                                      ...
                                                      <input type="text" class="form-control" name="price"
                                                          placeholder="enter price" value="{{ $user->price }}">
                                                  </div>
                                              </div>

                                              <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">PERIOD OF MEMBERSHIP</label>
                                                    <input type="text" class="form-control" name="price"
                                                        placeholder="enter price" value="{{ $user->period }}">
                                                </div>
                                              </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="price"
                                                            placeholder="enter price" value="{{ $user->email }}">
                                                    </div>
                                                </div>
                                            </div>
                                          </div>
